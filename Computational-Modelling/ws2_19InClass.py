...
def get_sol(dlx):
    ...
    # dlx=1.5              # Damage x location
    dly=0.5              # Damage y location

    #=========================================================
    # Fixed parameters
    #=========================================================
    dlr=0.25              # Damage radius
    ...
    # Create the mesh
    #=========================================================
    mesh = TriFEMLibD_InClass.TriOMesh();
    mesh.loadMesh(n,dlx,dly,dlr)
